        ...
        <div class= "container g-pt-30" style="font-size: 12px; margin-bottom: 25px;" >
            <div id="content">
                ...
                <br><div align="justify">
                    ...
                    <br><dd><b>SEGUNDA.- MONTO DE LOS SERVICIOS</b>. El monto total de los servicios que <b>“ICATECH”</b>, pagará al <b>“PRESTADOR DE SERVICIOS”</b> será por la cantidad de <b>${{$cantidad}} ({{$data_contrato->cantidad_letras1}} {{$monto['1']}}/100 M.N.)</b>; por curso impartido, menos las retenciones que el ICATECH le retendrá como pago provisional por concepto del Impuesto sobre la Renta, de conformidad con lo establecido en el Artículo 96 de la Ley del Impuesto sobre la Renta, enterando a las Autoridades Hacendarias las retenciones correspondientes.</dd>
