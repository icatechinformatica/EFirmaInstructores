                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- @if($a->porcentaje_asis < 80 && !is_null($a->porcentaje_asis))
                                        ...
                                        @endif --}}
                                    @if($a->porcentaje_asis < 80 && !is_null($a->porcentaje_asis))
                                        <span class="text-danger">Tiene {{$a->porcentaje_asis}}% de asistencia</span>
                                    @elseif(!is_null($a->porcentaje_asis))
                                        <span class="text-success">Tiene {{$a->porcentaje_asis}}% de asistencia</span>
                                    @else
                                        <span class="text-primary">No se ha registrado asistencia</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
